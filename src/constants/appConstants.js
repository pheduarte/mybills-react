...
export const NOTIFICATION_SETTINGS_STORAGE_KEY = 'mybills-notification-settings-v1'
export const NOTIFICATION_SENT_STORAGE_KEY = 'mybills-notification-sent-v1'
